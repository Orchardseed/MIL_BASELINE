...
```shell
python split_datasets_k_fold_train_val.py --seed 42 --csv_path /datasets/example_Dataset.csv --save_dir /your/save/dir --dataset_name Your_Dataset_Name --k 5
```
...
```shell
python split_datasets_k_fold_train_val_then_test.py --seed 42 --csv_path /datasets/example_Dataset.csv --save_dir /your/save/dir --dataset_name Your_Dataset_Name --k 5 --test_ratio 0.2
```
...
```shell
python split_datasets_k_fold_train_val_test.py --seed 42 --csv_path /datasets/example_Dataset.csv --save_dir /your/save/dir --dataset_name Your_Dataset_Name --k 5 --val_ratio 0.2
```
...
```shell
python splits_datasets_user_define_train_val_test.py --seed 42 --csv_path /datasets/example_Dataset.csv --save_path /your/save/csv --dataset_name Your_Dataset_Name --train_ratio 0.6 --val_ratio 0.2 --test_ratio 0.2
```
...
```shell
python splits_datasets_user_define_train_test.py --seed 42 --csv_path /datasets/example_Dataset.csv --save_path /your/save/csv --dataset_name Your_Dataset_Name --train_ratio 0.7 --test_ratio 0.3
```
...
```shell
python splits_datasets_user_define_train_val.py --seed 42 --csv_path /datasets/example_Dataset.csv --save_path /your/save/csv --dataset_name Your_Dataset_Name --train_ratio 0.7 --val_ratio 0.3
```
